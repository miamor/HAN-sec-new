...
class PrepareData(object):
    ...
    def gen_node_name_embedding_data(self):
        ...
        for graph_name in self.node_names_by_graph:
            ...
            self.node_name_embedding_data_csv.append({'class': self.mapping[label], 'data': node_name, 'file': graph_name})
            # self.node_name_embedding_data_csv__cls[label].append('{}'.format(node_name))
            self.node_name_embedding_data_csv__cls[label].append({'class': self.mapping[label], 'data': node_name, 'file': graph_name})
