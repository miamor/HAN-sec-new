...
class PrepareData(object):
    ...
    def load_data_files(self, task_ids, report_file_name=None, report_dir_path=None, write_to_json=True):
        """
        ...
        if task_ids is None:
            if report_dir_name is None:
                report_dir_name = os.path.basename(report_dir_path)
            ...
            if report_file_name is None: # loop through folder
                for report_file_name in os.listdir(report_dir_path):
                    report_path = report_dir_path+'/'+report_file_name
