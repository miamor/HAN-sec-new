...
from models.layers.gat_w_new import GATLayer, MultiHeadGATLayer
...
class Model(nn.Module):
    ...
    def build_model(self):
        ...
        # self.fc = nn.Linear(layer_params['n_heads'][-1]*layer_params['hidden_dim'][-1], 1)
    ...
    def forward(self, g):
        ...
        # print('att_last shape', self.g.ndata['att_last'].shape)
